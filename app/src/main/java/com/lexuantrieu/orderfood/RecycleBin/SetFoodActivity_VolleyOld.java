//package com.lexuantrieu.orderfood.RecycleBin;
//
...
//
//public class SetFoodActivity_VolleyOld extends AppCompatActivity {
//
...
//                        SetFoodActivity_VolleyOld.this,
...
//                        if(ckUploadImage) {
//                            AddFoodToData();
//                            Toast.makeText(SetFoodActivity_VolleyOld.this, "Đã thêm!!!", Toast.LENGTH_SHORT).show();
//                            edtnameFood.setText("");
...
//        SetFoodActivity_VolleyOld.bitmap.compress(Bitmap.CompressFormat.JPEG,100,byteArray);
//
...
//                        Toast.makeText(SetFoodActivity_VolleyOld.this, "Xảy ra lỗi. Vui lòng thử lại.", Toast.LENGTH_SHORT).show();
//                    }
//                })
//        {
//            @Override
